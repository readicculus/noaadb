...
#     @is_point.expression
#     def is_point(cls):
#         return cls.x1==cls.x2 and cls.y1 == cls.y2
#
#     def to_dict(cls):
#         res = {
#             'id': cls.id,
...
#     image_id = Column(FILENAME, ForeignKey(IRImage.event_key), nullable=False)
...
#     row_id = Column(Integer, primary_key=True,autoincrement=True)
#     id = Column(Integer, ForeignKey(LabelEntry.id, ondelete="CASCADE"),unique=True)
#     image_id = Column(FILENAME, ForeignKey(EOImage.event_key), nullable=False)
